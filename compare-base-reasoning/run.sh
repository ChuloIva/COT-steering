...
python compare_reasoning.py --n_examples 100 --max_tokens 2000 --skip_viz --model Qwen/Qwen2.5-1.5B-Instruct # Not available in OpenRouter
python compare_reasoning.py --n_examples 100 --max_tokens 2000 --skip_viz --model Qwen/Qwen2.5-14B-Instruct # Not available in OpenRouter
python compare_reasoning.py --n_examples 100 --max_tokens 2000 --skip_viz --model Qwen/Qwen2.5-32B-Instruct # Not available in OpenRouter
